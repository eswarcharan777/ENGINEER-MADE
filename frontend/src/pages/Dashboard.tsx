...
const featureMenu = [
  ['overview','📊','Dashboard'], ['ai-tutor','🤖','AI Engineering Tutor'], ['doubt-upload','📷','Code & Diagram Doubts'], ['recommendation','✨','Recommendations'], ['continue','▶','Continue Learning'], ['quiz','🧠','Module Quizzes'], ['flashcards','🗂️','Flashcards'], ['coding','💻','Coding Practice'], ['projects','🚀','Projects'], ['certificates','🏆','Certificates'], ['bookmarks','🔖','Bookmarks'], ['notes','📝','Notes'], ['resume','📄','Resume Builder'], ['reports','🚩','Report Content'], ['goals','🎯','Weekly Goals'], ['schedule','⏰','Schedule Task'], ['languages','🌐','Languages'], ['offline','📱','Mobile & Offline'], ['assessment','🧩','Skill Assessments'], ['groups','👥','Study Groups'], ['simulations','⚙️','Simulations'], ['interviews','🎙️','Mock Interviews'], ['repo-analysis','🔎','Repository Analysis'], ['analytics','📈','Advanced Analytics'], ['skill-tree','🌳','Skill Tree'], ['adaptive-practice','🎯','Adaptive Practice'], ['weakness-heatmap','🗺️','Weakness Heatmap'], ['daily-challenge','⚡','Daily Challenge'], ['ai-summarizer','🧾','AI Summarizer'], ['cheatsheet','🗒️','Cheatsheet Generator'], ['career-explorer','🧭','Career Explorer'], ['job-readiness','📐','Job Readiness Predictor'], ['placement','🔒','Placement Preparation · Coming soon'],
];
