...
const featureMenu = [
  ['overview','📊','Dashboard'], ['ai-tutor','🤖','AI Engineering Tutor'], ['doubt-upload','📷','Code & Diagram Doubts'], ['recommendation','✨','Recommendations'], ['continue','▶','Continue Learning'], ['quiz','🧠','Module Quizzes'], ['coding','💻','Coding Practice'], ['projects','🚀','Projects'], ['certificates','🏆','Certificates'], ['bookmarks','🔖','Bookmarks'], ['notes','📝','Notes'], ['resume','📄','Resume Builder'], ['reports','🚩','Report Content'], ['goals','🎯','Weekly Goals'], ['languages','🌐','Languages'], ['offline','📱','Mobile & Offline'], ['assessment','🧩','Skill Assessments'], ['groups','👥','Study Groups'], ['simulations','⚙️','Simulations'], ['interviews','🎙️','Mock Interviews'], ['placement','🎓','Placement Preparation'], ['repo-analysis','🔎','Repository Analysis'], ['leaderboard','🥇','College Leaderboard'], ['analytics','📈','Advanced Analytics'], ['skill-tree','🌳','Skill Tree'], ['adaptive-practice','🎯','Adaptive Practice'], ['weakness-heatmap','🗺️','Weakness Heatmap'], ['daily-challenge','⚡','Daily Challenge'], ['ai-summarizer','🧾','AI Summarizer'], ['cheatsheet','🗒️','Cheatsheet Generator'], ['career-explorer','🧭','Career Explorer'], ['job-readiness','📐','Job Readiness Predictor'],
];
